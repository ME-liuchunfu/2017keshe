...
import static xin.spring.library.R.id.bookAuthorEditText;
import static xin.spring.library.R.id.bookNameEditText;
import static xin.spring.library.R.id.bookNumberEditText;
import static xin.spring.library.R.id.bookPriceEditText;
